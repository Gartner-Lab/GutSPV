...
if (len(images)) == 0:
    print("No .png images found in the folder " + sys.argv[1] + ".")
    exit()

print(images)

# Sort files based run index and time point in [idx]_[time].png
images = sorted(images, key=lambda s : ( int(s.split("_")[0]), \
